		...
		<div class="container">
			...
			<div class="row">
				<div class="col">
					...
					<?php
											foreach ($Liste_produits as $row1) {
												?>
						<!-- Product -->
						<div class="product">
							<div class="product_image"><img src="attachment/<?php echo $row1["Prod_File"]; ?>" alt=""></div>
							<div class="product_extra product_new"><a href="categories.php">New</a></div>
							<div class="product_content">
								<div class="product_title"><a href="product.php?Identifiant=<?PHP echo $row1['Identifiant']; ?>"><?PHP echo $row1['Nom'];   ?></a></div>
								<div class="product_price"><?PHP echo $row1['Prix'];   ?>Dt</div>
							</div>
						</div>
						<?PHP
											}
