                ...
                <div class="row">
                    <div class="col-lg-8 contact_col">
                        <div class="get_in_touch">
                            <div class="section_title">Inscription</div>
                            <div class="section_subtitle">Bienvenue</div>
                            <div class="contact_form_container">
                                <form id="contact_form" method="POST" action="validation.php" class="contact_form">
                                    <fieldset>
                                        <div class="row">
                                            <div class="col-xl-6">
                                                <label for="user_name">Nom: </label>
                                                <input type="text" name="user_name" class="contact_input" required><br>
                                            </div >
                                        </div>
                                        <div>
                                            <label for="user_email">Email: </label>
                                            <input type="email" name="user_email" class="contact_input" required><br>
                                        </div>
                                        <div>
                                            <label for="user_pass">Password: </label>
                                            <input type="password" name="user_pass" class="contact_input" required><br>
                                        </div>
                                        <div>
                                            <label for="user_pass2">Once more: </label>
                                            <input type="password" name="user_pass2" class="contact_input" required><br>
                                            <input type="hidden" name="role" value="Client" class="contact_input">
                                        </div>
