...
include "Entities/commentaireCrud.php";
...
$commentaireGestion= new commentaireCrud($bd);
                ...
                <div class="row">
                    <div class="col-lg-8 contact_col">
                        <div class="get_in_touch">
                            ...
                            <div class="section_subtitle">Modifier post</div>
                            <?php
                            $billetArray=$billetGestion->get($_GET);
                            $billet->hydrate($billetArray);
                            $billet->setPseudo($billetArray['pseudo']);
                            if(isset($_SESSION['user_email']))
                            {
                                ?>
                                <div class="contact_form_container">
                                    <form id="contact_form" method="POST" action="modifier_post_validation.php" class="contact_form">
                                        <fieldset>
                                            <div>
                                                <label for="titre">Titre: </label>
                                                <input type="text" name="titre" class="contact_input" value="<?php echo $billet->titre();?>"><br>
                                            </div>
                                            <div>
                                                <input type="hidden" name="pseudo" value="<?php echo $billet->pseudo();?>"/>
                                                <input type="hidden" name="id" value="<?php echo $billet->id();?>"/>
                                                <label for="contenu">Contenu: </label>
                                                <input type="text" name="contenu" class="contact_input contact_textarea" value="<?php echo $billet->contenu();?>"><br>
                                            </div>
                                            <input type="submit" value="Submit" class="button contact_button" />
                                        </fieldset>
                                    </form>
                                </div>
                                <?php
                            ...
                            else
                            {
                                echo "
                                    <div class='newsletter_title'>
                                        <b>Vous n'êtes pas connecter, veuillez vous connecter pour pouvoir ajouter votre billet. <a href=\"login.php\">Connexion</a> ou <a href=\"authentification.php\">Inscription</a>.</b>
                                    </div>
                                ";
                            }
                            ?>
