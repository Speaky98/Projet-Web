                ...
                <div class="row">
                    <div class="col-lg-8 contact_col">
                        <div class="get_in_touch">
                            <div class="section_title">Connexion</div>
                            <div class="section_subtitle">Bienvenue</div>
                            <span class="contact_form_container">
                                <form id="contact_form" method="POST" action="verification.php" class="contact_form">
                                    <fieldset>
                                        <div>
                                        ...
                                        <div>
                                            ...
                                            <div class="section_subtitle"><a href="oubli_mdp.php">Mot de passe oublié?</a></div>
                                        </div>
