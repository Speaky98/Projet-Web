			            ...
			            <div class="row">
				            <div class="col-lg-8 offset-lg-2">
					            <div class="newsletter_content text-center">
									...
									{
										$nouveau_client->hydrate($_POST);
										
										if(!$bdd->emailExist($_POST))
										{
											$bdd->add($nouveau_client);
											?>
											<div class="newsletter_title">
												<b>Votre compte est validé. Veuillez maintenant <a href="login.php">vous connecter.</a></b>
											</div>
											<?php
										}
										else
										{
											echo "
												<div class='newsletter_title'>
													<b>Votre email existe déjà, veuillez choisir un autre <a href=\"authentification.php\">email</a></b>
												</div>
											";
										}
									}
