			            ...
			            <div class="row">
				            <div class="col-lg-8 offset-lg-2">
					            <div class="newsletter_content text-center">
                                    <?php 
                                    if(controleSaisie($_POST))
                                    {
                                        if($bdd->passwordConfirm($_POST))
                                        {
                                            $compteArray=$bdd->get($_POST);
                                            if($compteArray['role'] == "Admin")
                                            {
                                                ?>
                                                <div class="newsletter_title">
                                                    <b>Bienvenue Admin.</br><a href="index.php">Acceuil.</a></b>
                                                </div>
                                                <?php
                                            ...
                                            else 
                                            {
                                                ?>
                                                <div class="newsletter_title">
                                                    <b>Bienvenue Client.</br><a href="index.php">Acceuil.</a></b>
                                                </div>
                                                <?php
                                            }
