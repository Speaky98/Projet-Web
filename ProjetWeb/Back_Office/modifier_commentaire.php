                                ...
                                <div class="home_content">
                                    <div class="breadcrumbs">
                                        <ul>
                                            ...
                                            <li>Modification de commentaire</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-8 contact_col">
                        <div class="get_in_touch">
                            ...
                            <div class="section_subtitle">Modifier commentaire</div>
                            <?php
                            $commentaireArray=$commentaireGestion->get($_GET);
                            $commentaire->hydrate($commentaireArray);
                            $commentaire->setCommentateur($commentaireArray['commentateur']);
                            ...
                            if(isset($_SESSION['user_email']))
                            {
                                ...
                                <div class="contact_form_container">
                                    <form id="contact_form" method="POST" action="modifier_commentaire_validation.php" class="contact_form">
                                        <fieldset>
                                            <div>
                                                <input type="hidden" name="commentateur" value="<?php echo $commentaire->commentateur();?>"/>
                                                <input type="hidden" name="id_billet" value="<?php echo $commentaire->id_billet();?>"/>
                                                <input type="hidden" name="id" value="<?php echo $commentaire->id();?>"/>
                                                <label for="msg">Commentaire: </label>
                                                <input type="text" name="msg" class="contact_input contact_textarea" value="<?php echo $commentaire->msg();?>"><br>
                                            </div>
                            ...
                            else
                            {
                                echo "
                                    <div class='newsletter_title'>
                                        <b>Vous n'êtes pas connecter, veuillez vous connecter pour pouvoir ajouter votre commentaire. <a href=\"login.php\">Connexion</a> ou <a href=\"authentification.php\">Inscription</a>.</b>
                                    </div>
                                ";
                            }
                            ?>
