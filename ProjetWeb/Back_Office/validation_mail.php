			            ...
			            <div class="row">
				            <div class="col-lg-8 offset-lg-2">
					            <div class="newsletter_content text-center">
                                    <?php 
                                    if($compteCore->emailExist($_POST))
                                    {
                                        $compteArray= $compteCore->get($_POST);
                                        $to_email = $_POST['user_email'];
                                        $subject = 'Mot de passe Oublié';
                                        $message = 'Mot de passe: ' . $compteArray['user_pass'];
                                        $headers = 'From: prodigy@prodigy.com';
                                        mail($to_email,$subject,$message,$headers);
                                        echo "
                                        <div class='newsletter_title'>
                                        <b>Un email vous a été envoyé.<a href=\"login.php\">Connexion</a>.</b>
                                        </div>
                                        ";
                                    }
                                    else
                                    {
                                        echo "
                                        <div class='newsletter_title'>
                                        <b>Email innexistant.<a href=\"login.php\">Réessayez</a> ou inscrivez vous: <a href=\"authentification.php\">içi</a>.</b>
                                        </div>
                                        ";
                                    }
                                    /*$rand = rand(100000,999999);
                                    $to_email = echo $_POST['user_email'];
                                    $subject = 'Mot de passe Oublié';
									...
									echo "
									<div class='newsletter_title'>
									<b>Mot de passe ou Email incorrect <a href=\"login.php\">réessayez</a> ou inscrivez vous: <a href=\"authentification.php\">içi</a>.</b>
									</div>
									";*/
                                    ?>
					            </div>
