                ...
                <div class="row">
                    <div class="col-lg-8 contact_col">
                        <div class="get_in_touch">
                            ...
                            <div class="section_subtitle">Ajout commentaire</div>
                            <?php
                            $id_billet=$_GET['id'];
                            if(isset($_SESSION['user_email']))
                            {
                                ...
                                <div class="contact_form_container">
                                    <form id="contact_form" method="POST" action="commentaire_valide.php" class="contact_form">
                                        <fieldset>
                                            <div>
                                                <input type="hidden" name="commentateur" value="<?php echo $_SESSION['user_name'];?>"/>
                                                <input type="hidden" name="id_billet" value="<?php echo $id_billet;?>"/>
                                                <label for="msg">Commentaire: </label>
                                                <input type="text" name="msg" class="contact_input contact_textarea" required><br>
                                            </div>
