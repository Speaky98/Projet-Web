			            ...
			            <div class="row">
				            <div class="col-lg-8 offset-lg-2">
					            <div class="newsletter_content text-center">
                                    ...
                                    $billetArray=$billetGestion->get($_POST);
                                    $_POST['date_creation'] = $billetArray['date_creation'];
                                    $billet->hydrate($_POST);
                                    $billet->setPseudo($_POST['pseudo']);

                                    $billetGestion->update($billet);
                                    ?>
                                    <div class='newsletter_title'>
										<b>Votre billet a bien été modifié. <a href="forum.php">Retour au forum</a>.</b>
									</div>
					            </div>
				            </div>
			            </div>
