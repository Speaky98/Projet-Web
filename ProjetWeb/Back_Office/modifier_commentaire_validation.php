			            ...
			            <div class="row">
				            <div class="col-lg-8 offset-lg-2">
					            <div class="newsletter_content text-center">
                                    <?php 
                                    $commentaireArray=$commentaireGestion->get($_POST);
                                    $_POST['date_publication'] = $commentaireArray['date_publication'];
                                    $commentaire->hydrate($_POST);
                                    $commentaire->setCommentateur($_POST['commentateur']);
                                    $id_billet=$commentaire->id_billet();
                                    $commentaireGestion->update($commentaire);
                                    ?>
                                    <div class='newsletter_title'>
										<b>Votre commentaire a bien été modifié. <a href="post.php?id=<?php echo $id_billet;?>">Retour au post</a>.</b>
									</div>
					            </div>
				            </div>
			            </div>
