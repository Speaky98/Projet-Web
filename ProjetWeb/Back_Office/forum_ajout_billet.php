                ...
                <div class="row">
                    <div class="col-lg-8 contact_col">
                        <div class="get_in_touch">
                            ...
                            <div class="section_subtitle">Ajout billet</div>
                            <?php
                            if(isset($_SESSION['user_email']))
                            {
                                ?>
                                <div class="contact_form_container">
                                    <form id="contact_form" method="POST" action="billet_valide.php" class="contact_form">
                                        <fieldset>
                                            <div>
                                                <label for="titre">Objet: </label>
                                                <input type="text" name="titre" class="contact_input" required><br>
                                            </div>
                                            <div>
                                                <label for="contenu">Contenu: </label>
                                                <input type="text" name="contenu" class="contact_input contact_textarea" required><br>
                                            </div>
                            ...
                            else
                            {
                                echo "
                                    <div class='newsletter_title'>
                                        <b>Vous n'êtes pas connecté, veuillez vous connecter pour pouvoir ajouter votre post. <a href=\"login.php\">Connexion</a> ou <a href=\"authentification.php\">Inscription</a>.</b>
                                    </div>
                                ";
                            }
                            ?>
