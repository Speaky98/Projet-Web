<?php
    ...
    if (isset($_POST['insert'])){
        ...
        $query="INSERT INTO `contact`(`first name`,`last name`,`email`,`message`) VALUES ('$first_name','$last_name','$email','$message')";
						...
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							...
							<div class="header_extra ml-auto">
								...
								<li class="hassubs" style="margin-top: 23%;margin-left: -20%;">
									<a style="font-weight: bold; color:black;" href="">	</a>
										<ul >
							...
							<form action="#" id="contact_form" class="contact_form" method="post">
								<div class="row">
									<div class="col-xl-6">
										...
										<input type="text" id="contact_name" class="contact_input" required="required" name="firstname">
									</div>
